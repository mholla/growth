...
c...  ------------------------------------------------------------------
     ...
     # props(nprops),coords(3),drot(3,3),dfgrd0(3,3),dfgrd1(3,3)
      ...
      call umat_iso_morph_Abaqus(stress,statev,ddsdde,sse,
...
c...  ------------------------------------------------------------------
      subroutine umat_iso_morph_Abaqus(stress,statev,ddsdde,sse,
     #                                 time,dtime,coords,props,dfgrd1,
     #                                 ntens,ndi,nshr,nstatv,nprops,
     #                                 noel,npt,kstep,kinc)
c...  ------------------------------------------------------------------
c * " This UMAT is written for the Abaqus Neohookean constitutive material.
c * " It implements morphogenetic isotropic growth.
