...
c...  initialize material parameters 
      ...
      tcr   = props(4)              ! critical stretch
      tmax  = props(5)              ! maximum growth
      gam   = props(6)              ! exponential growth rate
...
c...  ------------------------------------------------------------------
 ...
 200     continue      
         ...
         fac = kg*dtime/dres/(3*theg) ! coefficient for growth tangent
