...
c...  ------------------------------------------------------------------
     ...
     # props(nprops),coords(3),drot(3,3),dfgrd0(3,3),dfgrd1(3,3)
      ...
      call umat_length_morph(stress,statev,ddsdde,sse,
...
c...  ------------------------------------------------------------------
      subroutine umat_length_morph(stress,statev,ddsdde,sse,
     #                             time,dtime,coords,props,dfgrd1,
     #                             ntens,ndi,nshr,nstatv,nprops,
     #                             noel,npt,kstep,kinc)
c...  ------------------------------------------------------------------
...
c...  material properties
      real*8  lam, mu, xf0(3), alpha !, tau, tmax
...
c...  initialize material parameters 
      ...
      !  tau = props(6)               ! exponential growth rate
      !  tmax = props(7)              ! growth limit

c...  calculate deformed elastic fiber 
      norm = sqrt(xf0(1)*xf0(1) + xf0(2)*xf0(2) + xf0(3)*xf0(3))
      xf(1) = (dfgrd1(1,1)*xf0(1) + dfgrd1(1,2)*xf0(2) + dfgrd1(1,3)*xf0(3))/norm
      xf(2) = (dfgrd1(2,1)*xf0(1) + dfgrd1(2,2)*xf0(2) + dfgrd1(2,3)*xf0(3))/norm
      xf(3) = (dfgrd1(3,1)*xf0(1) + dfgrd1(3,2)*xf0(2) + dfgrd1(3,3)*xf0(3))/norm
...
c...  elastic and geometric tangent
