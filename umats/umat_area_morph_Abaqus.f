...
c...  ------------------------------------------------------------------
     ...
     # props(nprops),coords(3),drot(3,3),dfgrd0(3,3),dfgrd1(3,3)
      ...
      call umat_area_morph_Abaqus(stress,statev,ddsdde,sse,
...
c...  ------------------------------------------------------------------
      subroutine umat_area_morph_Abaqus(stress,statev,ddsdde,sse,
     #                                  time,dtime,coords,props,dfgrd1,
     #                                  ntens,ndi,nshr,nstatv,nprops,
     #                                  noel,npt,kstep,kinc)
c...  ------------------------------------------------------------------
...
c...  calculate elastic tensor Fe = 1\sqrt(theg)*F + (1-1/sqrt(theg))*n \otimes n
      fe(1,1) = 1.d0/sqrt(theg)*dfgrd1(1,1) + (1.d0 - 1.d0/sqrt(theg))*xn(1)*xn(1)
      fe(1,2) = 1.d0/sqrt(theg)*dfgrd1(1,2) + (1.d0 - 1.d0/sqrt(theg))*xn(1)*xn(2)
      fe(1,3) = 1.d0/sqrt(theg)*dfgrd1(1,3) + (1.d0 - 1.d0/sqrt(theg))*xn(1)*xn(3)
      fe(2,1) = 1.d0/sqrt(theg)*dfgrd1(2,1) + (1.d0 - 1.d0/sqrt(theg))*xn(2)*xn(1)
      fe(2,2) = 1.d0/sqrt(theg)*dfgrd1(2,2) + (1.d0 - 1.d0/sqrt(theg))*xn(2)*xn(2)
      fe(2,3) = 1.d0/sqrt(theg)*dfgrd1(2,3) + (1.d0 - 1.d0/sqrt(theg))*xn(2)*xn(3)
      fe(3,1) = 1.d0/sqrt(theg)*dfgrd1(3,1) + (1.d0 - 1.d0/sqrt(theg))*xn(3)*xn(1)
      fe(3,2) = 1.d0/sqrt(theg)*dfgrd1(3,2) + (1.d0 - 1.d0/sqrt(theg))*xn(3)*xn(2)
      fe(3,3) = 1.d0/sqrt(theg)*dfgrd1(3,3) + (1.d0 - 1.d0/sqrt(theg))*xn(3)*xn(3)
